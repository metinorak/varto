...
func (mr *MockMiddlewareMockRecorder) OnAddConnection(conn any) *gomock.Call {
...
func (mr *MockMiddlewareMockRecorder) OnBroadcastToAll(data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMiddlewareMockRecorder) OnPublish(topic, data any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMiddlewareMockRecorder) OnRemoveConnection(conn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMiddlewareMockRecorder) OnSubscribe(conn, topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMiddlewareMockRecorder) OnUnsubscribe(conn, topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
